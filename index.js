...
createMenuItem('Pizza', 5, 'Dinner');
createMenuItem('Soup', 3, 'Lunch');
createMenuItem('Sandwich', 5, 'Dinner');
...
reviews.push({
  name: 'Sam',
  rating: 5,
  feedback: 'It was the greatest experience of my life. I will be back soon'
});
